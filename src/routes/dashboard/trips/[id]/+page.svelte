        ...
        {#if showItemForm}
            <form
                ...
                use:enhance={() => async ({ update, result }) => {
                    await update();
                    if (result.type === 'success') showToast('Itinerary item added successfully!');
                    showItemForm = false;
                }}
            >
                <div class="field-row">
        ...
        {#if showBookingForm}
            ...
            {:else}
                <form
                    ...
                    use:enhance={() => async ({ update, result }) => {
                        await update();
                        if (result.type === 'success') showToast('Booking added successfully!');
                ...
                >
                    ...
                    <p style="color:var(--muted);font-size:0.82rem;margin-top:-0.4rem;">
                        If the currency isn't INR, the live forex rate is fetched automatically to convert it to INR.
                    </p>
                    <div class="field-row">
                        <div class="field">
