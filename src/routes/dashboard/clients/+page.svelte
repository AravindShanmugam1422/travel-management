        ...
        <div class="card">
            <form
                ...
                use:enhance={() => async ({ update, result }) => {
                    await update();
                    if (result.type === 'success') showToast('Client added successfully!');
                    showForm = false;
                }}
            >
                <div class="field-row">
    ...
    {#if editingClient}
        <div class="card">
            ...
            <form
                ...
                use:enhance={() => async ({ update, result }) => {
                    await update();
                    if (result.type === 'success') showToast('Client updated successfully!');
                    editingClient = null;
                }}
            >
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap;">
                                ...
                                <form
                                    ...
                                    use:enhance={() => async ({ update, result }) => {
                                        await update();
                                        if (result.type === 'success') showToast('Client deleted.');
                                    }}
                                    onsubmit={(e) => {
