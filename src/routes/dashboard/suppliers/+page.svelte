...
<div class="page">
    ...
    {#if showForm}
        <div class="card">
            <form method="POST" action="?/addSupplier" use:enhance={() => async ({ update, result }) => { await update(); if (result.type === 'success') showToast('Supplier added successfully!'); showForm = false; }}>
                <div class="field-row">
                    <div class="field">
    ...
    {#if editingSupplier}
        <div class="card">
            ...
            <form
                ...
                use:enhance={() => async ({ update, result }) => { await update(); if (result.type === 'success') showToast('Supplier updated successfully!'); editingSupplier = null; }}
            >
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap;">
                                ...
                                <form
                                    ...
                                    use:enhance={() => async ({ update, result }) => { await update(); if (result.type === 'success') showToast('Supplier deleted.'); }}
                                    onsubmit={(e) => {
