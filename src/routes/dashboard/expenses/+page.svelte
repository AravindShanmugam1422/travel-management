    ...
    {#if showForm}
        <div class="card">
            <form
                method="POST"
                action="?/addExpense"
                use:enhance={() => async ({ update, result }) => { await update(); if (result.type === 'success') showToast('Expense added successfully!'); showForm = false; }}
            >
                <div class="field">
    ...
    {#if editingExpense}
        <div class="card">
            ...
            <form
                ...
                use:enhance={() => async ({ update, result }) => { await update(); if (result.type === 'success') showToast('Expense updated successfully!'); editingExpense = null; }}
            >
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap;">
                                ...
                                <form
                                    ...
                                    use:enhance={() => async ({ update, result }) => { await update(); if (result.type === 'success') showToast('Expense deleted.'); }}
                                    onsubmit={(e2) => {
